...
def main() -> int:
    ...
    network_present = bool(args.network_interface and args.network_interface in links)
    ...
    rows = [
        {
            ...
            "evidence": "; ".join(picos) or "no PicoScope USB device",
        ...
        },
        {
            ...
            "hardware_present": network_present,
            "software_ready": bool(network_present and shutil.which("tcpdump") and packet_ok),
            "mapping_verified": False,
            "paper_role": "distributed workloads only; not useful for local fused-update semantics",
            "evidence": f"interface={args.network_interface or 'not specified'}; {packet_note}",
